      ...
      <details>
        ...
        <div class={tw`flex flex-col items-center`}>
          ...
          <p class={tw`p-4`}>
            ...
            server via GitHub actions, and recently I have been creating a web
          ...
          <p class={tw`p-4`}>
            ...
            called KMongo, to store configurations and other data. Pinguino's
            new website is being written in{" "}
      ...
      <details>
        ...
        <div class={tw`flex flex-col items-center`}>
          <p class={tw`p-4`}>
            ...
            Discord server from archiving (as they usually do within one week of
            inactivity). NoArchive was my first bot built using KordEx, and it
            also interacts with a MongoDB database.
          </p>
          <img
